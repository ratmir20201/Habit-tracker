...
info_message = (
    ...
    "Вместе мы будем следить за твоим прогрессом, помогать тебе не пропускать важные действия и достигать целей. "
    "Добавляй привычки, отмечай выполнение и следи за своими успехами — всё в одном месте! "
